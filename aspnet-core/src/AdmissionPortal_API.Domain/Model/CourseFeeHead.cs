...
{
   public  class CourseFeeHead
    {
        public class AddCourseFeeHead
        {
            [JsonIgnore]
        ...
        public class AddCourseFeeHeadFEE
        {
            [JsonIgnore]
            public int UniversityCollegeId { get; set; }
            //[Required(ErrorMessage = "Please Provied Course")]
        ...
        public class UpdateCourseFeeHead
        {
        ...
        public class CourseFeeHeadDetails
        {
            public int Id { get; set; }
            public int UniversityCollegeId { get; set; }
        ...
        public class FeedHeadDetailsByCourse
        {
            public string HeadName { get; set; }
            [Range(typeof(Decimal), "0", "100000", ErrorMessage = "{0} must be a decimal/number between {1} and {2}.")]
            public decimal? Fee { get; set; } = 0;
        ...
        public class CourseFeeByCollegId
        {
        ...
        public class GetCourseFeeWaveOff
        {
