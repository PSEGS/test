...
{
    public class PGObjectionService : IPGObjectionService
    {
        private readonly IPGObjectionRepository _pgPbjectionRepository;
        private readonly IMapper _mapper;
        private readonly IConfiguration _configuration;
        private readonly IBlobService _blobService;
        private readonly ILogError _logError;
        public PGObjectionService(IPGObjectionRepository pgPbjectionRepository, IMapper mapper, IConfiguration configuration, ILogError logError, IBlobService blobService)
        {
            _logError = logError;
            _pgPbjectionRepository = pgPbjectionRepository;
            _mapper = mapper;
            _blobService = blobService;
            _configuration = configuration;
        }

        public async Task<ServiceResult> CreateObjectionAsync(AddPgObjection model)
        {
            ServiceResult serviceResult = new ServiceResult();
            try
            {

                var obj = _mapper.Map<AddPgObjection>(model);
                var _result = _pgPbjectionRepository.CreateObjectionAsync(obj);
        ...
        public async Task<ServiceResult> GetObjectionById(int objectonId)
        {
            ...
            try
            {
                var _result = _pgPbjectionRepository.GetObjectionById(objectonId);
        ...
        public async Task<ServiceResult> GetAllObjectionsByRegId(string regId)
        {
            ...
            try
            {
                var _result = _pgPbjectionRepository.GetAllObjectionsByRegId(regId);
        ...
        public async Task<ServiceResult> GetAllObjectionsByCollegeId(string collegeId)
        {
            ...
            try
            {
                var _result = _pgPbjectionRepository.GetAllObjectionsByCollegId(collegeId);
