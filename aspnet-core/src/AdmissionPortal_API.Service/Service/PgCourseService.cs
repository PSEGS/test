...
{
    public class PgCourseService : IPgCourseService
    {
        private readonly IPgCourseRepository _coursePgRepository;
        private readonly IMapper _mapper;
        private readonly IConfiguration _configuration;
        private readonly IBlobService _blobService;
        private readonly ILogError _logError;
        public PgCourseService(IPgCourseRepository coursePgRepository, IMapper mapper, IConfiguration configuration, ILogError logError, IBlobService blobService)
        {
            _logError = logError;
        ...
        public async Task<ServiceResult> CreateCourseAsync(AddPgCourse model)
        {
            ServiceResult serviceResult = new ServiceResult();
            try
            {

                var obj = _mapper.Map<AddPgCourse>(model);
                
                var _result = _coursePgRepository.AddAsyncCourse(obj);
        ...
        public async Task<ServiceResult> DeleteCourse(int courseid, int userid)
        {
            ...
            try
            {
                var _result = _coursePgRepository.DeleteCourse( userid, courseid);
        ...
        public async Task<ServiceResult> GetAllCourse(int pageNumber, int pageSize, string searchKeyword, string sortBy, string sortOrder)
        {
            ...
            try
            {
                var _result = _coursePgRepository.GetAllCourse( pageNumber, pageSize, searchKeyword, sortBy, sortOrder);
        ...
        public async Task<ServiceResult> GetCourseById(int courseId)
        {
            ...
            try
            {
                var _result = _coursePgRepository.GetCourseById(courseId);
        ...
        public async Task<ServiceResult> UpdateCourse(UpdatePgCourse model)
        {
            ServiceResult serviceResult = new ServiceResult();
            try
            {
                var obj = _mapper.Map<UpdatePgCourse>(model);
                var _result = _coursePgRepository.UpdateCourse(obj);
